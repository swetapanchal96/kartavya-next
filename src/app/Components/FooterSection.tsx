      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-8 pb-10 border-b border-white/20">
          ...
          <div className="flex items-center gap-4 max-w-sm">
            <div className="bg-secondary hover:bg-yellow p-4 rounded-full text-primary text-xl shrink-0 transition-all duration-500 ease-in-out">
          ...
          <div className="flex items-center group gap-4">
            <div className="bg-secondary group-hover:bg-yellow  p-4 rounded-full text-primary text-xl shrink-0 transition-all duration-500 ease-in-out">
              ...
              {[FaYoutube, FaXTwitter, FaFacebookF, FaLinkedinIn].map(
                (Icon, i) => (
                  <Link
                    key={i}
                    href="#"
                    className="bg-secondary hover:bg-white p-4 rounded-full text-primary hover:scale-110 transition-transform"
                  >
                    <Icon size={22} />
                  </Link>
                )
              ...
              {["Home", "About Us", "Services", "Product", "Latest Blog"].map(
                (item) => (
                  <li key={item}>
                    <Link
                      href="#"
                      className="hover:text-secondary text-md transition-colors"
                    >
                      {item}
                    </Link>
                  </li>
